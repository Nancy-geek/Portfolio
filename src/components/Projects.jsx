...
import {guessNum,todo,password,tictak,pwskills, currency, ecom } from '../assets/techlogo.js' 
  ...
  const cardItems=[      // array of objects
    {
      ...
      pic:ecom,
      name: "E-Com",
      gitref: "https://github.com/Nancy-geek/E-Commerce-React",
      live: "https://e-commerce-react-theta-seven.vercel.app/"
    ...
    {id:3,
      ...
      live: "https://currency-convertorintime.netlify.app/"
    },
    ...
    {id:4,
      ...
      live: "https://generate-passwordrandom.netlify.app/"
    },
    {id:5,
      pic:guessNum,
      name:"Guess Number",
    ...
    {                       // curly braces for adding elements ....remember
     cardItems.map(({id,pic,name,gitref, live})=>(
      ...
      <div key={id} className=' flex flex-col justify-between min-h-48 max-h-52 max-w-56 border-white border-[2px] shadow-lg rounded-md pt-0 m-2 bg-cover relative overflow-hidden '>
        ...
        <img className="bg-cover p-0.4"  src={pic} alt="" />
