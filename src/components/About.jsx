...
function About() {
  return (
    <>
  <div id="About" className='m-1 p-2 mt-3 md:m-4 md:p-4 ' >
    ...
    <div className='sm:mt-5 mt-0 flex justify-center px-2 items-center   sm:space-x-7 lg:m-3 text-sm sm:text-base '> 
        ...
        <div className=' space-y-3 w-full md:w-3/4 shadow-sm p-0 md:p-3 md:px-6 lg:m-3 lg:p-7 flex lg:justify-center flex-col text-balance lg:text-justify rounded-md  shadow-indigo-950 '>
        {/* <h2>Greetings !!</h2> */}
        ...
        <p className='text-pretty flex-col'>
        I possess a keen interest in leveraging <b className='text-yellow-100'>Data Structures and Algorithms</b> using <b className='text-yellow-100'>Java</b> with an unwavering enthusiasm for coding and problem-solving. <span className='hidden lg:inline'>Over time, I have successfully tackled over 200+ distinct problems on renowned platforms such as GeeksforGeeks and LeetCode. </span><br />
